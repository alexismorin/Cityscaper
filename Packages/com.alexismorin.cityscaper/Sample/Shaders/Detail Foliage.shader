...
Shader "Detail Foliage"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 temp_output_19_0 = ( lerpResult16 * clampResult20 );
			o.Albedo = temp_output_19_0.rgb;
			o.Specular = temp_output_19_0.r;
			o.Alpha = 1;
...
/*ASEBEGIN
Version=16900
411;488;1165;531;540.019;155.9332;1.483543;True;True
...
Node;AmplifyShaderEditor.SamplerNode;14;-717.7368,419.6788;Float;True;Property;_FoliageB;Foliage B;2;0;Create;True;0;0;False;0;ba0d0baa2d6c43049bb66788744d3e59;07dab7f70bc29884fa4219e693f4c53e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4BDD21943AB1A61E6EC9A67B0BE982FD7E9B1E0A